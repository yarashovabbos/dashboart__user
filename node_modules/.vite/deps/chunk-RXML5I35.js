...
function useStyleRegister(info, styleFn) {
  ...
  return function(node2) {
    ...
    if (!ssrInline || isMergedClientSide || !defaultCache) {
      ...
      styleNode = React7.createElement("style", _extends({}, _defineProperty(_defineProperty({}, ATTR_TOKEN, cachedTokenKey), ATTR_MARK, cachedStyleId), {
...
var Col = React34.forwardRef((props, ref) => {
  const {
    getPrefixCls,
    direction
  ...
  const {
    gutter,
    wrap
  } = React34.useContext(RowContext_default);
  const {
  ...
  return wrapCSSVar(React34.createElement("div", Object.assign({}, others, {
...
function useForceUpdate() {
  const [, forceUpdate] = React35.useReducer((x) => x + 1, 0);
  return forceUpdate;
}
...
function useMergedPropByScreen(oriProp, screen) {
  const [prop, setProp] = React37.useState(typeof oriProp === "string" ? oriProp : "");
...
var Row = React37.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
    justify,
    align,
  ...
  const [screens, setScreens] = React37.useState({
    xs: true,
    sm: true,
    md: true,
    lg: true,
  ...
  const [curScreens, setCurScreens] = React37.useState({
    xs: false,
    sm: false,
    md: false,
    lg: false,
  ...
  const gutterRef = React37.useRef(gutter);
  const responsiveObserver = useResponsiveObserver();
  React37.useEffect(() => {
  ...
  const rowContext = React37.useMemo(() => ({
    gutter: [gutterH, gutterV],
    wrap
  }), [gutterH, gutterV, wrap]);
  return wrapCSSVar(React37.createElement(RowContext_default.Provider, {
    value: rowContext
  }, React37.createElement("div", Object.assign({}, others, {
    className: classes,
...
var ListContext = import_react20.default.createContext({});
...
var Meta = (_a) => {
  ...
  const content = import_react21.default.createElement("div", {
    className: `${prefixCls}-item-meta-content`
  }, title && import_react21.default.createElement("h4", {
    className: `${prefixCls}-item-meta-title`
  }, title), description && import_react21.default.createElement("div", {
    className: `${prefixCls}-item-meta-description`
  }, description));
  return import_react21.default.createElement("div", Object.assign({}, others, {
    className: classString
  }), avatar && import_react21.default.createElement("div", {
    className: `${prefixCls}-item-meta-avatar`
  }, avatar), (title || description) && content);
};
var InternalItem = import_react21.default.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
    children,
    actions,
  ...
  const {
    grid,
    itemLayout
  } = (0, import_react21.useContext)(ListContext);
  const {
    getPrefixCls,
    list
  } = (0, import_react21.useContext)(ConfigContext);
  ...
  const isItemContainsTextNodeAndNotSingular = () => {
    let result = false;
    import_react21.Children.forEach(children, (element) => {
      if (typeof element === "string") {
        result = true;
      }
    });
    return result && import_react21.Children.count(children) > 1;
  };
  const isFlexMode = () => {
  ...
  const prefixCls = getPrefixCls("list", customizePrefixCls);
  const actionsContent = actions && actions.length > 0 && import_react21.default.createElement("ul", {
    className: (0, import_classnames4.default)(`${prefixCls}-item-action`, moduleClass("actions")),
    key: "actions",
    style: moduleStyle("actions")
  }, actions.map((action, i) => (
    // eslint-disable-next-line react/no-array-index-key
    import_react21.default.createElement("li", {
      key: `${prefixCls}-item-action-${i}`
    }, action, i !== actions.length - 1 && import_react21.default.createElement("em", {
      className: `${prefixCls}-item-action-split`
    }))
  )));
  const Element = grid ? "div" : "li";
  const itemChildren = import_react21.default.createElement(Element, Object.assign({}, others, !grid ? {
    ref
  } : {}, {
    className: (0, import_classnames4.default)(`${prefixCls}-item`, {
      [`${prefixCls}-item-no-flex`]: !isFlexMode()
    }, className)
  }), itemLayout === "vertical" && extra ? [import_react21.default.createElement("div", {
    className: `${prefixCls}-item-main`,
    key: "content"
  }, children, actionsContent), import_react21.default.createElement("div", {
  ...
  return grid ? import_react21.default.createElement(col_default, {
    ref,
    flex: 1,
    style: colStyle
...
//# sourceMappingURL=chunk-RXML5I35.js.map
